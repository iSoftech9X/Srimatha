...
//       // Format combo items if this is a combo
//       if (formData.isCombo) {
...
//                   Combo Items: {currentComboItems.name}
//                 </h2>
//                 <button
//                   onClick={() => {
...
//                         const itemName = menuItem ? menuItem.name : item.name || "Select Item";
...
//                           setFormData({
//                             ...formData,
//                             comboItems: [...formData.comboItems, { id: 0, quantity: 1, name: "" }],
//                           });
//                         }}
