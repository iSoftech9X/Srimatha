...
const Footer: React.FC = () => {
  ...
  const handleAddressClick = () => {
    const address = `${restaurantInfo.address.line1}, ${restaurantInfo.address.line2}, ${restaurantInfo.address.line3}`;
    const encodedAddress = encodeURIComponent(address);
    window.open(`https://www.google.com/maps/search/?api=1&query=${encodedAddress}`);
  };

  // Function to handle phone number click (opens phone dialer)
  const handlePhoneClick = () => {
    window.open(`tel:${restaurantInfo.mobile}`);
  };

  // Function to handle email click (opens default email client)
  const handleEmailClick = () => {
    window.open('mailto:info@srimatha.com');
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/g/16uuVxDBD9/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="bg-gray-700 hover:bg-[#501608] p-3 rounded-full transition-colors duration-300">
                <Facebook size={20} />
              </a>
              <a href="https://www.instagram.com/sri_matha_foodcourt?igsh=NXNnb3NsczVhYXln" target="_blank" rel="noopener noreferrer" className="bg-gray-700 hover:bg-[#501608] p-3 rounded-full transition-colors duration-300">
                <Instagram size={20} />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="bg-gray-700 hover:bg-[#501608] p-3 rounded-full transition-colors duration-300">
                <Twitter size={20} />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="bg-gray-700 hover:bg-[#501608] p-3 rounded-full transition-colors duration-300">
                <Youtube size={20} />
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6">Quick Links</h4>
            <ul className="space-y-3">
              <li><a href="#home" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Home</a></li>
              <li><a href="#about" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">About Us</a></li>
              <li><a href="#services" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Services</a></li>
              <li><a href="#menu" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Menu</a></li>
              <li><a href="#gallery" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Gallery</a></li>
              <li><a href="#contact" className="text-gray-300 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              >
                <MapPin className="mr-3 mt-1 flex-shrink-0 text-orange-400" size={18} />
                <span className="text-gray-300 text-sm group-hover:text-orange-400 transition-colors duration-200 underline-offset-4 group-hover:underline">
                  {restaurantInfo.address.line1}<br />
                  {restaurantInfo.address.line2}<br />
                  {restaurantInfo.address.line3}
                </span>
              ...
              >
                <Mail className="mr-3 flex-shrink-0 text-orange-400" size={18} />
                <span className="text-gray-300 text-sm group-hover:text-orange-400 transition-colors duration-200 underline-offset-4 group-hover:underline">info@srimatha.com</span>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Privacy Policy</a>
              <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Terms of Service</a>
              <a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 underline-offset-4 hover:underline">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
